...
public interface ApkSignerEngine extends Closeable {
     ...
     *         from producing a valid signature. For example, if the engine needs to read
     *         {@code AndroidManifest.xml} but the entry is missing.
     ...
     *         engine from producing a valid signature. For example, if the engine needs to read
     *         {@code AndroidManifest.xml} but the entry is missing.
     * @throws NoSuchAlgorithmException if a signature could not be generated because a required
     *         cryptographic algorithm implementation is missing
     * @throws InvalidKeyException if a signature could not be generated because a signing key is
