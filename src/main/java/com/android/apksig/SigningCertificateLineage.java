...
public class SigningCertificateLineage {
    ...
    /**
     * Builder of an {@link SigningCertificateLineage}.
     */
    public static class Builder {

        /**
         * Constructs a new {@code Builder} for an {@code SigningCertificateLineage} which contains
         * proof of signing certificate rotation.  The builder may be used to modify the attributes
         * for chosen signing certificates, or to create a new descendant signing certificate.
         */
        public Builder() {
        }
        ...
        // TODO add method(s) to expand SigningCertificateLineage using old and new SignerConfigs
