...
public class ApkSigningBlockUtils {
    ...
    public static void verifyIntegrity(
            ...
            V2SchemeVerifier.Result result) throws IOException, NoSuchAlgorithmException {
        ...
        for (V2SchemeVerifier.Result.SignerInfo signerInfo : result.signers) {
            for (V2SchemeVerifier.Result.SignerInfo.ContentDigest expected : signerInfo.contentDigests) {
    ...
    public static ByteBuffer findApkSignatureSchemeBlock(
            ...
            int blockId,
            V2SchemeVerifier.Result result) throws SignatureNotFoundException {
    ...
    public static SignatureInfo findSignature(
            DataSource apk, ApkUtils.ZipSections zipSections, int blockId, V2SchemeVerifier.Result result)
    ...
    public static DataSource generateApkSigningBlockCDOffset(
