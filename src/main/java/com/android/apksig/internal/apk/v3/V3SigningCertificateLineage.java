...
import com.android.apksig.internal.apk.VerbatimX509Certificate;
...
public class V3SigningCertificateLineage {
    ...
    public static List<SigningCertificateNode> readSigningCertificateLineage(ByteBuffer inputBytes)
        ...
        int nodeCount = 0;
        if (inputBytes == null || inputBytes.remaining() == 0) {
            return null;
        }
            ...
            try {
                ...
                throw new SecurityException(
                        "Failed to verify signature over signed data for certificate #"
                                + nodeCount + " when parsing V3SigningCertificateLineage object", e);
            } catch (CertificateException e) {
