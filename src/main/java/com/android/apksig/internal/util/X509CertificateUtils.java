...
public class X509CertificateUtils {
    ...
    public static X509Certificate generateCertificate(byte[] encodedForm,
        ...
        try {
            ...
            // This could be expected if the certificate is encoded using an ambiguous BER encoding;
            // attempt to decode the certificate using the BER parser and reencode using the DER
            // encoder below.
        }
        try {
            Certificate reencodedCert = Asn1BerParser.parse(ByteBuffer.wrap(encodedForm), Certificate.class);
