    ...
    private void sign(
        ...
        for (final CentralDirectoryRecord inputCdRecord : inputCdRecordsSortedByLfhOffset) {
            ...
            if (shouldOutput) {
                ...
                long outputDataOffset = outputLocalFileHeaderOffset + outputLfrResult.data_offset_bytes;
                ...
                if (pinPatterns != null) {
                    ...
                    for (Hints.PatternWithRange pinPattern : pinPatterns) {
                        if (pinPattern.pattern.matcher(inputCdRecord.getName()).matches()) {
                            ...
                            Hints.ByteRange pin_range = pinPattern.ClampToAbsoluteByteRange(data_range);
                            if (pin_range != null) {
                                pinFileHeader = true;
