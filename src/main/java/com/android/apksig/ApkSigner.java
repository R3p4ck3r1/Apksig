...
public class ApkSigner {
    ...
    public static class Builder {
         ...
         *
         * <p>{@link #ApkSigner(ApkSignerEngine)} is an alternative for advanced use cases where
         ...
         * {@link #ApkSigner(List)} is more appropriate.
         */
         ...
         *
         * <p><em>Note:</em> This method may result in APK signatures which don't verify on all
         ...
         * with an {@link ApkSignerEngine}.
         *
         * @param enable {@code true} to require the APK to be signed using JAR signing,
         ...
         * with an {@link ApkSignerEngine}.
         *
         * @param enable {@code true} to require the APK to be signed using APK Signature Scheme v2,
         *        {@code false} to require the APK to not be signed using APK Signature Scheme v2.
         *
         * @throws IllegalStateException if this builder was initialized with an
         *         {@link ApkSignerEngine}
         *
