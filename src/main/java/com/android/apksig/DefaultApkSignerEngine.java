...
public class DefaultApkSignerEngine implements ApkSignerEngine {
    ...
    private OutputApkSigningBlockRequest2 outputZipSectionsInternal(
            DataSource zipEntries,
            DataSource zipCentralDirectory,
            DataSource zipEocd,
            boolean needPadding)
    ...
    private static class OutputApkSigningBlockRequestImpl implements OutputApkSigningBlockRequest2 {
        ...
        @Override
        public int getPadSizeBeforeApkSigningBlock() {
