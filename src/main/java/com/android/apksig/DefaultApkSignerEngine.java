...
import com.android.apksig.internal.apk.SigningBlockScheme.v2.V2SchemeSigner;
...
public class DefaultApkSignerEngine implements ApkSignerEngine {
    ...
    private List<ApkSigningBlockUtils.SignerConfig> createV2SignerConfigs(
        ...
        for (int i = 0; i < mSignerConfigs.size(); i++) {
            ...
            ApkSigningBlockUtils.SignerConfig
                    v2SignerConfig = new ApkSigningBlockUtils.SignerConfig();
    ...
    private OutputApkSigningBlockRequestImpl outputZipSectionsInternal(
        ...
        DataSource eocd =
                ApkSigningBlockUtils.generateApkSigningBlockCDOffset(beforeCentralDir, zipEocd);
        ...
        Pair<List<ApkSigningBlockUtils.SignerConfig>,
                Map<ContentDigestAlgorithm, byte[]>> v2DigestInfo =
                ApkSigningBlockUtils.computeContentDigests(beforeCentralDir, zipCentralDirectory,
                        eocd, v2SignerConfigs);
        Pair<byte[], Integer> apkSignatureSchemeV2Block =
                V2SchemeSigner.generateApkSignatureSchemeV2Block(v2DigestInfo.getFirst(),
                        v2DigestInfo.getSecond());
