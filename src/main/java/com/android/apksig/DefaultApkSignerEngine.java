...
public class DefaultApkSignerEngine implements ApkSignerEngine {
    ...
    private ApkSigningBlockUtils.SignerConfig createSigningBLockSignerConfig(
        ...
        newSignerConfig.apkSignerLineage = signerConfig.getApkSignerLineage();
    ...
    public static class Builder {
        ...
        /**
         * Sets the {@link SignerConfig} to use for signing with v1 and/or v2 signature schemes when using
         * a different SignerConfig for the v3 signature scheme.  This enables rotation to a new
         * SignerConfig on supported platforms while enabling an APK to still be seen as it was on
         * older platforms.
         */
