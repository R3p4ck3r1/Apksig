...
public class ApkSignerTest {
    ...
    private static void generateGoldenFiles(File outDir) throws Exception {
        ...
        signGolden(
                "original.apk",
                new File(outDir, "golden-rsa-minSdkVersion-1-maxSdkVersion-25-out.apk"),
                new ApkSigner.Builder(rsa2048SignerConfig).setMinSdkVersion(1)
                        .setMaxSdkVersion(25));
        signGolden(
                "original.apk",
                new File(outDir, "golden-rsa-minSdkVersion-18-maxSdkVersion-25-out.apk"),
                new ApkSigner.Builder(rsa2048SignerConfig).setMinSdkVersion(18)
                        .setMaxSdkVersion(25));
        signGolden(
                "original.apk",
                new File(outDir, "golden-rsa-minSdkVersion-24-maxSdkVersion-25-out.apk"),
                new ApkSigner.Builder(rsa2048SignerConfig).setMinSdkVersion(24)
                        .setMaxSdkVersion(25));
    }
    ...
    @Test
    public void testMaxSdkVersion_Golden() throws Exception {
        // Regression tests for minSdkVersion-based signature/digest algorithm selection
        // NOTE: Expected output files can be re-generated by running the "main" method.
        ...
        assertGolden("original.apk", "golden-rsa-out.apk", new ApkSigner.Builder(rsaSignerConfig));
        assertGolden(
                "original.apk", "golden-rsa-minSdkVersion-1-maxSdkVersion-25-out.apk",
                new ApkSigner.Builder(rsaSignerConfig).setMinSdkVersion(1).setMaxSdkVersion(25));
        assertGolden(
                "original.apk", "golden-rsa-minSdkVersion-18-maxSdkVersion-25-out.apk",
                new ApkSigner.Builder(rsaSignerConfig).setMinSdkVersion(18).setMaxSdkVersion(25));
        assertGolden(
                "original.apk", "golden-rsa-minSdkVersion-24-maxSdkVersion-25-out.apk",
                new ApkSigner.Builder(rsaSignerConfig).setMinSdkVersion(24).setMaxSdkVersion(25));
        assertGolden(
                "original.apk", "golden-rsa-minSdkVersion-24-out.apk",
                new ApkSigner.Builder(rsaSignerConfig).setMinSdkVersion(24).setMaxSdkVersion(28));
        assertGolden(
                "original.apk", "golden-rsa-minSdkVersion-24-out.apk",
                new ApkSigner.Builder(rsaSignerConfig).setMinSdkVersion(24));
